...
::: {.callout-warning}
We assume you have gone through the [preparation](https://github.com/Cambridge-ICCS/Summer-school-Intro-Git/blob/main/PREPARATION.md)
:::
...
- Gain an appreciation for how useful Version Control is
:::
